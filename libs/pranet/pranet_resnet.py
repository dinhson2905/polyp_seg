...
class CRANet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = ra4_feat + crop_4
        lateral_map_4 = F.interpolate(x, scale_factor=32, mode='bilinear') # S-2: (b, 1, 11, 11) -> (b, 1, 352, 352)
        ...
        x = ra3_feat + crop_3
        lateral_map_3 = F.interpolate(x, scale_factor=16, mode='bilinear') # S-3: (b, 1, 22, 22) -> (b, 1, 352, 352)
