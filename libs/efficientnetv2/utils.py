...
GlobalParams.__new__.__defaults__ = (None,) * len(GlobalParams.__fields)
BlockArgs.__new__.__defaults__ = (None,) * len(BlockArgs.__fields)
...
class MaxPool2dDynamicSamePadding(nn.MaxPool2d):
    def __init__(self, kernel_size, stride, padding=0, dilation=1, return_indices=True, ceil_mode=False):
        super().__init__(kernel_size, stride, padding, dilation, return_indices, ceil_mode)
        self.stride = [self.stride] * 2 if isinstance(self.dilation, int) else self.dilation
        self.kernel_size = [self.dilation] * 2 if isinstance(self.dilation, int) else self.dilation
...
def efficientnet(width_coefficient=None, depth_coefficient=None,
                image_size=None, dropout_rate=0.2, drop_connect_rate=0.2, num_classes=1000, include_top=True):
    blocks_args = [
