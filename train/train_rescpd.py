    ...
    for epoch in range(1, epochs):
        ...
        if (epoch+1) % 1 == 0:
            ...
            if meandice > best_dice_score:
                ...
                torch.save(model.state_dict(), save_path + 'resnetcpd.pth')
                print('[Saving Snapshots:]', save_path + 'resnetcpd.pth', meandice)
...
if __name__ == '__main__':
    ...
    log_file = 'logs/train_' + model_name + '_' + datetime.now().strftime('%Y%m%d%H') + '.log'
