...
from libs.hardmseg import HarDPD
    ...
    for epoch in range(1, epochs):
        ...
        if (epoch+1) % 1 == 0:
            ...
            if meandice > best_dice_score:
                ...
                torch.save(model.state_dict(), save_path + 'HarDPD_0611.pth')
                print('[Saving Snapshots:]', save_path + 'HarDPD_0611.pth', meandice)
        if epoch in [50, 60, 70, 80, 90]:
            file_ = 'hardpd_' + str(epoch) + '.pth'
...
if __name__ == '__main__':
    ...
    log_file = 'logs/train_hardpd_' + datetime.now().strftime('%Y%m%d%H') + '.log'
